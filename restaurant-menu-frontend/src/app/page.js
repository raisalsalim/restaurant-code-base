...
export default function Home() {
  ...
  useEffect(() => {
    axios
      .get("http://backend.raazresto.com/api/menu-items/") // Adjust the URL to match your backend
      .then((response) => {
  ...
  const handleCreate = () => {
    axios
      .post("http://backend.raazresto.com/api/menu-items/", newItem) // Sending new item to backend
      .then((response) => {
  ...
  const handleUpdate = () => {
    axios
      .put(`http://backend.raazresto.com/api/menu-items/${editItem.id}/`, editItem) // Sending updated item
      .then((response) => {
  ...
  const handleDelete = (id) => {
    axios
      .delete(`http://backend.raazresto.com/api/menu-items/${id}/`) // Deleting item
      .then(() => {
